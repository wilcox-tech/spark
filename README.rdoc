{<img src="https://secure.travis-ci.org/wilcox-tech/spark.png?branch=master" alt="Build Status" />}[http://travis-ci.org/wilcox-tech/spark]
...
Spark's defining, unique goals are simple:

  * Have a customisable UI
  * Voting on issues
  * Sane requirement management
  * Extremely granular authentication
  * Mobile device support
  * JSON / XML API for custom apps written against Spark.

There are very few open-source requirements management software, and the ones
that are on the market today are not designed for today's Agile development
